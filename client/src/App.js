import { Box, Container, FormControl, Button, Input, Text, TableContainer, Th, Tr, Table, Thead, Tbody, Drawer } from '@chakra-ui/react';
...
function App() {
  const { FetchUsers, Search, users, onOpen, isOpen, onClose } = useContext(GlobalContext);
